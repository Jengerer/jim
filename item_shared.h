...
const D3DCOLOR QUALITY_COMMON_COLOUR	= D3DCOLOR_XRGB( 255, 215, 0 );
const D3DCOLOR QUALITY_UNUSUAL_COLOUR	= D3DCOLOR_XRGB( 134, 80, 172 );
const D3DCOLOR QUALITY_VINTAGE_COLOUR	= D3DCOLOR_XRGB( 69, 97, 141 );
const D3DCOLOR QUALITY_GENUINE_COLOUR	= D3DCOLOR_XRGB( 75, 115, 83 );
const D3DCOLOR QUALITY_STRANGE_COLOUR	= D3DCOLOR_XRGB( 205, 155, 29 );
const D3DCOLOR QUALITY_COMMUNITY_COLOUR	= D3DCOLOR_XRGB( 112, 176, 74 );
const D3DCOLOR QUALITY_VALVE_COLOUR		= D3DCOLOR_XRGB( 165, 15, 121 );
