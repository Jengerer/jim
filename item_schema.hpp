...
typedef JUTIL::HashMap<unsigned int, const JUTIL::String*, KillEaterRank*, JUTIL::StringHasher> KillEaterRankMap;
...
public:
	...
	bool add_kill_eater_rank( const JUTIL::String* name, KillEaterRank* kill_eater_rank );
