...
class CMsgStartupCheck : public ::google::protobuf::Message {
 public:
  CMsgStartupCheck();
  virtual ~CMsgStartupCheck();
  
  CMsgStartupCheck(const CMsgStartupCheck& from);
  
  inline CMsgStartupCheck& operator=(const CMsgStartupCheck& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const CMsgStartupCheck& default_instance();
  
  void Swap(CMsgStartupCheck* other);
  
  // implements Message ----------------------------------------------
  
  CMsgStartupCheck* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const CMsgStartupCheck& from);
  void MergeFrom(const CMsgStartupCheck& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:CMsgStartupCheck)
 private:
  ...
  void InitAsDefaultInstance();
  static CMsgStartupCheck* default_instance_;
};
// -------------------------------------------------------------------

class CMsgStartupCheckResponse : public ::google::protobuf::Message {
 public:
  CMsgStartupCheckResponse();
  virtual ~CMsgStartupCheckResponse();
  
  CMsgStartupCheckResponse(const CMsgStartupCheckResponse& from);
  
  inline CMsgStartupCheckResponse& operator=(const CMsgStartupCheckResponse& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const CMsgStartupCheckResponse& default_instance();
  
  void Swap(CMsgStartupCheckResponse* other);
  
  // implements Message ----------------------------------------------
  
  CMsgStartupCheckResponse* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const CMsgStartupCheckResponse& from);
  void MergeFrom(const CMsgStartupCheckResponse& from);
  void Clear();
  bool IsInitialized() const;
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static CMsgStartupCheckResponse* default_instance_;
};
// -------------------------------------------------------------------
...
// optional fixed32 item_schema_version = 1;
inline bool CMsgStartupCheckResponse::has_item_schema_version() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void CMsgStartupCheckResponse::set_has_item_schema_version() {
  _has_bits_[0] |= 0x00000001u;
}
inline void CMsgStartupCheckResponse::clear_has_item_schema_version() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void CMsgStartupCheckResponse::clear_item_schema_version() {
  item_schema_version_ = 0u;
  clear_has_item_schema_version();
}
inline ::google::protobuf::uint32 CMsgStartupCheckResponse::item_schema_version() const {
  return item_schema_version_;
}
inline void CMsgStartupCheckResponse::set_item_schema_version(::google::protobuf::uint32 value) {
